...
const numberOfHats = prompt("Number of hats🤠? ");

// Print the game instructions
const printInstructions = console.log('To move the character, enter:\n> "u" to move up\n> "d" to move down\n> "r" to move right\n> "l" to move left\n> "q" quit.\n')

// Generate field
const myField = new Field(Field.generateField(10, 10, holesPercent, numberOfHats));
